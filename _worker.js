...
// Variables
const rootDomain = "bandayopenwrt.my.id"; // Ganti dengan domain utama kalian
const serviceName = "bandaywrt"; // Ganti dengan nama workers kalian
const apiKey = "aXK1wneBQ-H_r1ttnRDgrnGb_tp2sr62nq7kecsb"; // Ganti dengan Global API key kalian (https://dash.cloudflare.com/profile/api-tokens)
const apiEmail = "bandayopenwrt@gmail.com"; // Ganti dengan email yang kalian gunakan
const accountID = "85b70193d41b9ca1bfd94040ef6370ab"; // Ganti dengan Account ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
const zoneID = "4aa9ab435518e00235ed7ef9da453cdd"; // Ganti dengan Zone ID kalian (https://dash.cloudflare.com -> Klik domain yang kalian gunakan)
